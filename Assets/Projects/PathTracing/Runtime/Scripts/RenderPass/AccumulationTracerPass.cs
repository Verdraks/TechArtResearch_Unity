...
namespace PathTracer
{
    public class AccumulationTracerPass : ScriptableRenderPass
    {
        ...
        public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
        {
            ...
            if (resourceData.isActiveTargetBackBuffer || m_Settings.useAccumulation == false || cameraData.historyManager == null)
            {
                return;
            }
            ...
            if (history == null || history.CurrentFrame == null || history.PreviousFrame == null)
            {
                return;
            }
